 ...
 *                 description: The main category of the category
 *               name:
 *                 type: string
 ...
 * /api/category/v1/categories:
 *   get:
 *     summary: Retrieve paginated categories with optional search query
 *     tags: [Categories]
 *     parameters:
 *       - in: query
 *         name: page
 ...
 *         schema:
 *           type: string
 *         description: The search query to filter categories.
 *     responses:
 *       200:
 *         description: Categories retrieved successfully
 *         content:
 ...
 *                 type: string
 *                 format: binary
 *                 description: The new category image to upload
 *               mainCategory:
 *                 type: string
 *                 description: The main category of the category
 *               name:
