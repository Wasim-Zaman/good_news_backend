 ...
 *                 type: string
 *                 format: binary
 *                 description: The news image to upload
 *               title:
 *                 type: string
 *                 example: "News Title"
 ...
 *                 message:
 *                   type: string
 *                   example: News item retrieved successfully
 *                 data:
 *                   type: object
 *                   properties:
 *                     id:
 ...
 * /api/news/v1/news:
 *   get:
 *     summary: Retrieve paginated news items with optional search query
 *     tags: [News]
 *     parameters:
 *       - in: query
 *         name: page
 ...
 *         schema:
 *           type: string
 *         description: The search query to filter news items.
 *     responses:
 *       200:
 *         description: News items retrieved successfully
 *         content:
 ...
 *                 type: string
 *                 format: binary
 *                 description: The new news image to upload
 *               title:
 *                 type: string
